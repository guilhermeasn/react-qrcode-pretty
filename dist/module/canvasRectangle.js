export default function canvasRectangle(props) {
    var _a, _b, _c, _d;
    const radius = (typeof props.radius === 'number' || !props.radius) ? {
    ...
    } : Object.assign({ top_left: 0, top_right: 0, bottom_left: 0, bottom_right: 0 }, props.radius);
