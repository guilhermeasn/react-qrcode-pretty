        ...
        <Row>
          ...
          <Col lg={6}>
            ...
            <Form as='div' className="mt-3">
              ...
              <div className="mb-3 p-2 border border-2 rounded">
                <Form.Label>
                  Size ({ props.size })
                </Form.Label>
                <Form.Range
                  ...
                  step={ 50 }
                  value={ props.size }
                  onChange={(input: any) => setProps({ ...props, size: input.currentTarget.value })}
                />
              </div>
          ...
          <Col lg={6} className='center text-center'>
            ...
            <Accordion className='my-3'>
              <Accordion.Item eventKey='0'>
                ...
                <Accordion.Body className='text-start bg-code bg-opacity-10 rounded-bottom'>
            ...
            {format === 'canvas'
              ? <QrcodeCanvas {...props} padding={ (props.size ?? 200) / 10 } />
              : <QrcodeSVG {...props} padding={ (props.size ?? 200) / 10 } />
            }<br />
